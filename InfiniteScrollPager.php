 ...
 * For more examples and documentation visit https://github.com/metafizzy/infinite-scroll
 *
...
class InfiniteScrollPager extends Widget
{
    ...
    public function init()
    {
        ...
        if (is_null(ArrayHelper::getValue($this->pluginOptions['loading'], 'img', null))) {
            ...
            list ($imgPath, $imgUrl) = $assetManager->publish('@vendor/kriptograf/yii2-infinite-scroll/assets/images/ajax-loader.gif');
